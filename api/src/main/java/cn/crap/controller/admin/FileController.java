...
public class FileController extends BaseController {
    ...
    private String upload(MultipartFile file) {
        ...
        if (file.getSize() > 1024 * 1024 * Config.fileSize) {
            ...
            } else if (Config.fileType.indexOf(suffix) >= 0) {
                saveUrl += "resources/upload/files";
            } else {
                saveUrl += "resources/upload/otherFiles";
            }
    ...
    public void updateAllFileToAliyun() {
        ...
        try {
            String basePath = Tools.getCanWriteDestDir() + "resources/upload";
    ...
    public static void updateFileToAliyun(File file, OSSClient client) {
        if (file != null) {
            if (file.isDirectory()) {
                ...
                try {
                    String fileUrl = file.getAbsolutePath().replace(Tools.getCanWriteDestDir(), "");
